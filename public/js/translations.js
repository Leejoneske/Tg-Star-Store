...
const translations = {
    en: {
        ...
        enterTelegramUsernames: "Enter Telegram usernames. They will be validated and IDs shown.",
    ...
    ru: {
        ...
        enterTelegramUsernames: "Введите Telegram имена пользователей. Они будут проверены и показаны ID.",
