...
class VersionDisplay {
    ...
    async init() {
        try {
            ...
            this.versionInfo = {
                ...
                branch: 'main',
                displayVersion: 'StarStore v1.12.28'
            };
        }
        ...
        try {
            ...
            if (elements.length === 0) {
                ...
                const versionElements = Array.from(allElements).filter(el => 
                    el.textContent && el.textContent.includes('StarStore v1.12.28')
                );
    ...
    getDisplayVersion() {
        return this.versionInfo ? this.versionInfo.displayVersion : 'StarStore v1.12.28';
    }

    getShortVersion() {
        return this.versionInfo ? `StarStore v${this.versionInfo.version}` : 'StarStore v1.12.28';
    }
