...
class VersionDisplay {
    ...
    async init() {
        try {
            ...
            this.versionInfo = {
                ...
                branch: 'main',
                displayVersion: 'StarStore v2.3.21'
            };
        }
        ...
        try {
            ...
            if (elements.length === 0) {
                ...
                const versionElements = Array.from(allElements).filter(el => 
                    el.textContent && el.textContent.includes('StarStore v2.3.21')
                );
    ...
    getDisplayVersion() {
        return this.versionInfo ? this.versionInfo.displayVersion : 'StarStore v2.3.21';
    }

    getShortVersion() {
        return this.versionInfo ? `StarStore v${this.versionInfo.version}` : 'StarStore v2.3.21';
    }
