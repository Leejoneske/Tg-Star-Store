...
class TelegramFullscreenManager {
    ...
    enableFullscreen() {
        ...
        try {
            ...
            // Header/background color intentionally NOT set — letting Telegram use
            // its default transparent header avoids the foggy/blocked phone status
            // bar that appears in light theme when a fixed color is forced.
    ...
    enableImmersiveMode() {
        ...
        try {
            ...
            // Leave header color untouched (see note in enableFullscreen).
